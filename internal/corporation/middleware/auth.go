...
// AuthMiddleware provides authentication and authorization for corporation operations
...
// This is a basic authenticated access requirement for corporation information
func (m *AuthMiddleware) RequireCorporationAccess(ctx context.Context, authHeader, cookieHeader string) (*models.AuthenticatedUser, error) {
