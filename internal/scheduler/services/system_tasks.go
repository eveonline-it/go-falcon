...
func GetSystemTasks() []*models.Task {
	...
	return []*models.Task{
		...
		},
		{
			...
			Description: "Cleans up expired group memberships",
			Type:        models.TaskTypeSystem,
		...
		},
		{
			...
			Description: "Synchronizes Discord roles with group memberships",
			Type:        models.TaskTypeSystem,
			...
			Metadata: models.TaskMetadata{
				...
				RetryInterval: 5 * time.Minute,
				Timeout:       15 * time.Minute,
				Tags:          []string{"system", "discord", "groups"},
				IsSystem:      true,
				Source:        "system",
				Version:       1,
			},
		...
		{
			ID:          "system-sde-update-check",
			Name:        "SDE Update Check",
			Description: "Checks for EVE SDE updates and initiates downloads",
			Type:        models.TaskTypeSystem,
			...
			Metadata: models.TaskMetadata{
				...
				Tags:          []string{"system", "sde", "updates"},
				IsSystem:      true,
				Source:        "system",
				Version:       1,
			},
...
var SystemTaskDefinitions = map[string]models.SystemTaskDefinition{
	...
	"system-group-membership-validation": {
		Name:        "Group Membership Validation",
		Description: "Validates corporate memberships against EVE Online data",
		Schedule:    "Every 6 hours",
		Purpose:     "Ensures group memberships remain accurate with current corp/alliance data",
		Priority:    "Normal",
	},
	"system-group-cleanup": {
		Name:        "Group Membership Cleanup",
		Description: "Removes expired and invalid group memberships",
		Schedule:    "Daily at 3:30 AM",
		Purpose:     "Maintains data integrity by removing outdated memberships",
		Priority:    "Normal",
	},
	"system-discord-sync": {
		Name:        "Discord Role Synchronization",
		Description: "Synchronizes Discord roles with current group memberships",
		Schedule:    "Every 4 hours",
		Purpose:     "Keeps Discord permissions in sync with group membership changes",
		Priority:    "Normal",
	},
	"system-sde-update-check": {
		Name:        "SDE Update Check",
		Description: "Checks for new EVE Static Data Export updates and initiates downloads",
		Schedule:    "Daily at 6:00 AM",
		Purpose:     "Keeps EVE data current with the latest game information",
		Priority:    "Normal",
	},
}