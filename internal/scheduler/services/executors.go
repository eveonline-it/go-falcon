...
func NewSystemExecutor(authModule AuthModule, groupsModule interface{}) *SystemExecutor {
...
func (e *SystemExecutor) Execute(ctx context.Context, task *models.Task) (*models.TaskResult, error) {
	...
	case "sde_update_check":
		return &models.TaskResult{
			Success: false,
			Error:   "SDE module has been removed",
			Output:  "SDE functionality is no longer available",
		}, nil
	default:
		return &models.TaskResult{
			Success:  false,
