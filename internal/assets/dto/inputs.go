...
type GetCharacterAssetsRequest struct {
	...
	LocationID  *int64 `query:"location_id" json:"location_id,omitempty" doc:"Optional: filter by location ID"`
...
type GetCorporationAssetsRequest struct {
	...
	LocationID    *int64 `query:"location_id" json:"location_id,omitempty" doc:"Optional: filter by location ID"`
	Division      *int   `query:"division" json:"division,omitempty" minimum:"1" maximum:"7" doc:"Optional: filter by division (1-7)"`
	Page          int    `query:"page" json:"page,omitempty" minimum:"1" default:"1" doc:"Page number"`
	PageSize      int    `query:"page_size" json:"page_size,omitempty" minimum:"1" maximum:"1000" default:"100" doc:"Items per page"`
}
...
type GetAssetTrackingRequest struct {
	CharacterID   *int32 `query:"character_id" json:"character_id,omitempty" doc:"Filter by character ID"`
	CorporationID *int32 `query:"corporation_id" json:"corporation_id,omitempty" doc:"Filter by corporation ID"`
	Enabled       *bool  `query:"enabled" json:"enabled,omitempty" doc:"Filter by enabled status"`
}
...
type GetAssetSnapshotsRequest struct {
	CharacterID   *int32 `query:"character_id" json:"character_id,omitempty" doc:"Filter by character ID"`
	CorporationID *int32 `query:"corporation_id" json:"corporation_id,omitempty" doc:"Filter by corporation ID"`
	LocationID    *int64 `query:"location_id" json:"location_id,omitempty" doc:"Filter by location ID"`
