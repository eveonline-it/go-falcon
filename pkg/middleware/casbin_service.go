...
func (s *CasbinService) SyncUserHierarchy(ctx context.Context, userID string, characters []UserCharacter) error {
...
func (s *CasbinService) getUserExpandedContext(ctx context.Context, userID string) (*ExpandedAuthContext, error) {
